  ...
  >
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-width="120px" >
      ...
      <el-form-item label="法人" prop="principal">
        <el-input v-model.trim="temp.principal" placeholder="请输入法人" autocomplete="off" clearable/>
      </el-form-item>
      ...
      <el-form-item label="违章类型" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入违章类型" autocomplete="off" clearable/>
      </el-form-item>
      <el-form-item label="处罚事项" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入处罚事项" autocomplete="off" clearable/>
      </el-form-item>
      <el-form-item label="处理状态" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入处理状态" autocomplete="off" clearable/>
      </el-form-item>
      <el-form-item label="排查次数" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入排查次数" autocomplete="off" clearable/>
      </el-form-item>
      <el-form-item label="" prop="mobile">
        <el-button type="primary" class="btn_blue02">添加违章</el-button>
      </el-form-item>
      <el-form-item label="排查时间" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入排查时间" autocomplete="off" clearable/>
      </el-form-item>
      <el-form-item label="排查内容" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入排查内容" autocomplete="off" clearable/>
      </el-form-item>
    </el-form>
    <el-form ref="dataForm" :rules="rules" :model="temp" label-width="120px" >
      <el-form-item label="排查结果" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入排查结果" autocomplete="off" clearable/>
      </el-form-item>

      <el-form-item label="营业执照" prop="mobile">
        <SingleImage
          :tempUrl="temp.imgUrl"
