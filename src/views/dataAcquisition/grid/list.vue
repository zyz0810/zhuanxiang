  ...
  <div class="app-container">
    <div class="bg_white">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="网格名称" align="center" prop="name"></el-table-column>
        <el-table-column label="责任部门" align="center" prop="name"></el-table-column>
        <el-table-column label="网格代码" align="center" prop="name"></el-table-column>
      </el-table>
