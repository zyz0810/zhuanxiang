...
<!--  <el-divider></el-divider>-->
  ...
  <el-table v-loading="listLoading" :data="list" :height="tableHeight"
    ...
    <el-table-column label="今日未处理量" align="center" prop="name"></el-table-column>
    <el-table-column label="今日黄灯件" align="center" prop="name"></el-table-column>
    <el-table-column label="今日红灯件" align="center" prop="name"></el-table-column>
  </el-table>
