<template>
  ...
  >
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-width="140px" >
      <el-form-item label="井盖编号" prop="number_no">
        <el-input v-model.trim="temp.number_no" placeholder="请输入井盖编号" autocomplete="off" :disabled="isCanView" clearable/>
      </el-form-item>
      <el-form-item label="IMEI号" prop="imei">
        <el-input v-model.trim="temp.imei" placeholder="请输入IMEI号" autocomplete="off" :disabled="isCanView" clearable/>
      </el-form-item>
      <el-form-item label="井盖状态" prop="status">
        <el-select v-model="temp.status" placeholder="请选择井盖状态" :disabled="isCanView" clearable>
          <el-option label="正常" :value="1"></el-option>
          <el-option label="异常" :value="2"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="井盖运行状态" prop="install_status">
        <el-select v-model="temp.install_status" placeholder="请选择井盖运行状态" :disabled="isCanView" clearable>
          <el-option label="已安装" value="已安装"></el-option>
          <el-option label="未安装" value="未安装"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="最后更新时间" prop="update_at">
        <el-date-picker
          v-model="temp.update_at"
          type="datetime"
          :disabled="isCanView"
      ...
      <el-form-item label="自检时间" prop="create_at">
        <el-date-picker
    ...
    <el-form ref="dataForm" :rules="rules" :model="temp" label-width="140px" style="padding-right: 20px;">
      <el-form-item label="地址" prop="address">
        ...
        <div id='mapDiv' class="mapDiv mt_10" style="width: 100%;height: 300px;"></div>
      </el-form-item>
    </el-form>
...
<script>
  ...
  import {addWellLid,editWellLid} from '@/api/data'
  ...
  export default {
    ...
    methods: {
      ...
      getView(){
        const { id, number_no, imei, address, install_status, status,update_at,
          create_at,lat,log,} = this.paraData.option;
        this.temp = { id, number_no, imei, address, install_status, status,update_at,
          create_at,lat,log,}
      },
