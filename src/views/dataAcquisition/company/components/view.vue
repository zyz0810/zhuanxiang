  ...
  >
    <el-form ref="dataForm" :rules="rules" :model="temp" label-width="140px" class="mr_20">
      <el-form-item label="名称" prop="company">
        <el-input v-model.trim="temp.company" placeholder="请输地名称" autocomplete="off" :disabled="isCanView" clearable/>
      </el-form-item>
      ...
      <el-form-item label="联系人" prop="link_man">
        <el-input v-model.trim="temp.link_man" placeholder="请输入联系人" autocomplete="off" :disabled="isCanView" clearable/>
      </el-form-item>
      <el-form-item label="电话" prop="mobile">
        <el-input v-model.trim="temp.mobile" placeholder="请输入电话" autocomplete="off" :disabled="isCanView" clearable/>
      </el-form-item>

      <el-form-item label="养护范围" prop="content">
        <el-input v-model.trim="temp.content" placeholder="请输入养护范围" autocomplete="off" :disabled="isCanView" clearable/>
      </el-form-item>
...
<script>
  ...
  import {addConserve,editConserve,} from '@/api/data'
  ...
  export default {
    ...
    methods: {
      ...
      getView(){
        const { id, company, type, link_man, mobile, content,address,lat,log,} = this.paraData.option;
        this.temp = {id, company, type, link_man, mobile, content,address,lat,log,}
      },
