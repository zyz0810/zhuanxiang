  ...
  <div class="app-container">
    <div class="bg_white">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="工地名称" align="center" prop="name"></el-table-column>
        <el-table-column label="工程类别" align="center" prop="name"></el-table-column>
        <el-table-column label="有效期" align="center" prop="name"></el-table-column>
        <el-table-column label="地址" align="center" prop="name"></el-table-column>
        <el-table-column label="操作" align="center" min-width="160">
          <template slot-scope="scope">
            <el-button class="btn_green" type="primary" @click="">更新</el-button>
            <el-button class="btn_blue02" type="primary" @click="">查看</el-button>
