  ...
  <div class="app-container">
    <div class="bg_white p20">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="权限类目描述" align="center" prop="name"></el-table-column>
        <el-table-column label="状态" align="center" prop="address"></el-table-column>
        <el-table-column label="操作" align="center" min-width="160">
          <template slot-scope="scope">
            <el-button class="btn_blue02" type="primary" @click="">编辑</el-button>
            <el-button class="btn_blue01" type="primary" @click="">添加</el-button>
