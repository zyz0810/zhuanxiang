  ...
  <div class="app-container">
    <div class="bg_white p20">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="部门电话" align="center" prop="name"></el-table-column>
        <el-table-column label="主要负责人" align="center" prop="address"></el-table-column>
        <el-table-column label="负责人电话" align="center" prop="address"></el-table-column>
