  ...
  <div class="app-container">
    <div class="bg_white">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="应用类型" align="center" prop="name"></el-table-column>
        <el-table-column label="平台名称" align="center" prop="name"></el-table-column>
        <el-table-column label="角色" align="center" prop="address"></el-table-column>
