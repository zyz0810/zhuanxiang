  ...
  <div class="app-container">
    <div class="bg_white">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="数据库类型" align="center" prop="name"></el-table-column>
        <el-table-column label="数据库连接串" align="center" prop="name"></el-table-column>
        <el-table-column label="视图名称" align="center" prop="name"></el-table-column>
