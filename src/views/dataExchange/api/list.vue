  ...
  <div class="app-container">
    <div class="bg_white">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="当前版本" align="center" prop="name"></el-table-column>
        <el-table-column label="当前版本发布时间" align="center" prop="name"></el-table-column>
        <el-table-column label="操作" align="center" min-width="160">
          <template slot-scope="scope">
            <el-button class="btn_blue02" type="primary" @click="">编辑</el-button>
            <el-button class="btn_yellow" type="primary" @click="">用户</el-button>
