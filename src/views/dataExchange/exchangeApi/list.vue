  ...
  <div class="app-container">
    <div class="bg_white">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight"
        ...
        <el-table-column label="接口地址" align="center" prop="name"></el-table-column>
        <el-table-column label="AppKey" align="center" prop="name"></el-table-column>
        <el-table-column label="AppSecret" align="center" prop="name"></el-table-column>
        <el-table-column label="调用时间间隔（s）" align="center" prop="name"></el-table-column>
        <el-table-column label="是否自动启动" align="center" prop="name"></el-table-column>
        <el-table-column label="交换类型" align="center" prop="name"></el-table-column>
      </el-table>
